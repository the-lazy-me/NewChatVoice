...
class UserPreference:
    def __init__(self, launcher_id: str = ""):
        ...
        self.config = ConfigManager("data/plugins/NewChatVoice/config/config", "plugins/NewChatVoice/templates/config", launcher_id=self.launcher_id)
        self.character_path = "data/plugins/NewChatVoice/data/character.json"
        self.temp_dir_path = "data/plugins/NewChatVoice/audio_temp"
    ...
    async def load_config(self) -> None:
        ...
        self.temp_dir_path = self.config.data.get("temp_dir_path", "data/plugins/NewChatVoice/audio_temp")
